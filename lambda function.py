...
def validate_order_flowers(flower_type, date, pickup_time):
    flower_types = ['Lilies', 'Roses', 'Tulips','Lavender', 'Daisy',"Sunflower",'Chrysanthemum','Babysbreath']
...
def order_flowers(intent_request):
    ...
    if source == 'DialogCodeHook':
        ...
        # on the bot model.
        prices = {'Lilies': 100, 'Roses': 200, 'Tulips':90,'Lavender':150, 'Daisy':150,"Sunflower": 180,'Chrysanthemum':100,'Babysbreath':300}
        output_session_attributes['Price'] = prices.get(flower_type.lower(), 12)
